...
Module Memory
    ...
    Public Function ReadInt8(ByVal P As Process, ByVal memAdr As Integer) As Integer
        Return ReadBytes(P, memAdr, 1)(0)
    End Function

    Public Function ReadInt16(ByVal P As Process, ByVal memAdr As Integer) As Integer
        Return BitConverter.ToInt16(ReadBytes(P, memAdr, 2), 0)
    End Function

    Public Function ReadInt32(ByVal P As Process, ByVal memAdr As Integer) As Integer
    ...
    Private Function ReadBytes(ByVal P As Process, ByVal memAdr As Integer, ByVal bytesToRead As UInteger) As Byte()
        Dim ptrBytesRead As Byte
